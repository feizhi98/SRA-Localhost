...
def registration_form():
    ...
    with st.form(key="StudRegAndCourseForm", clear_on_submit=True):
        studentID = st.number_input("Enter student ID",min_value=0)
...
def assessment():
    ...
    with st.form("AssessmentForm", clear_on_submit=True):
        studentID = st.number_input("Enter student ID",min_value=0)
        code_presentation = st.selectbox('Select semester', semester)
...
def vle():
    ...
    with st.form("VleForm", clear_on_submit=True):
        activity_type = st.selectbox('Select activity type', activity)
        sum_click = st.number_input("Enter sum of clicks",min_value=0)
        button = st.form_submit_button("Submit")
...
def student_info():
    ...
    with st.form("StudentInfoForm", clear_on_submit=True):
        ...
        studied_credits = st.number_input("Enter studied credits",min_value=0)
        code_presentation = st.selectbox('Select semester', semester)
        course = st.selectbox('Select code module', code_module)
        sum_click = st.number_input("Enter sum of clicks",min_value=0)
        After_Clicks = st.number_input("Enter sum of after clicks",min_value=0)
        Before_Clicks = st.number_input("Enter sum of before clicks",min_value=0)
